...
import application.CollectionReceiptsController_view.Delta;
...
public class CollectionReceiptsController_viewconsumable {
    ...
    @FXML private void back(MouseEvent event) { loadFXML("collectionreciepts_list_consumable.fxml", event); }
    ...
    private void out(MouseEvent event) {
        try {
            ...
            e.printStackTrace();
            System.out.println("Failed to open log_out.fxml");
        }
    }
    @FXML
    private void deposit(MouseEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("collectionPOPup STATUS_under DEPOSITEDconsumable.fxml"));
            Parent root = loader.load();
    ...
    private void remit(MouseEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("collectionPOPup STATUS_under REMITTEDconsumable.fxml"));
            Parent root = loader.load();
