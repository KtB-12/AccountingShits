...
public class collection_machine_paymentdetails {
    ...
    private void add_to_list(MouseEvent event) {
        ...
        if (cashCheckBox.isSelected()) {
            fxmlToOpen = "collectionPOPupmachine_under CASH.fxml";
        } else if (chequeCheckBox.isSelected()) {
            fxmlToOpen = "collectionPOPup machine_under CHEQUE.fxml";
        } else if (fundTransferCheckBox.isSelected()) {
            fxmlToOpen = "collectionPOPup machine_under FUND TRANSFER.fxml";
        }
