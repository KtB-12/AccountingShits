...
public class NewAccountControlleredit {
    ...
    public void loadAccountData(Account account) {
        ...
        municipality.setText(account.getMunicipality());
        prov.getEditor().setText(account.getProvince());

        autofillFieldsFromProvince(account.getProvince());
    }
